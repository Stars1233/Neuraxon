...
# New features in v2.29: Global NeuroModulator updates# Neuraxon Game of Life v.2.34 (Research Version): Inherit Synaptic Weights update
# Based on the Paper "Neuraxon: A New Neural Growth & Computation Blueprint" by David Vivancos https://vivancos.com/  & Dr. Jose Sanchez  https://josesanchezgarcia.com/
# https://www.researchgate.net/publication/397331336_Neuraxon
# Play the Lite Version of the Game of Life at https://huggingface.co/spaces/DavidVivancos/NeuraxonLife
# New features in V2.2:  Enhance Full Feldged Inheritance
...
def Inheritance(father: 'NxEr', mother: 'NxEr') -> 'NeuraxonNetwork':
    ...
    def inherit_synapse_properties(child_synapse):
        ...
        # --- Inherit Synaptic Weights ---
        child_synapse.w_fast = pick_or_blend(f_s.w_fast, m_s.w_fast)
        child_synapse.w_slow = pick_or_blend(f_s.w_slow, m_s.w_slow)
        child_synapse.w_meta = pick_or_blend(f_s.w_meta, m_s.w_meta)
